...
- [ResNet.py](https://github.com/LayerAct/LayerAct/blob/main/models/ResNet.py) is implementation of [ResNet (He et al., 2016)](https://openaccess.thecvf.com/content_cvpr_2016/papers/He_Deep_Residual_Learning_CVPR_2016_paper.pdf) for the experiment. The implementation reffered to the [implementation of pytorch](https://github.com/pytorch/vision/blob/main/torchvision/models/resnet.py).  
